...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapStateToProps = __webpack_require__(80);

	var _mapStateToProps2 = _interopRequireDefault(_mapStateToProps);

	var _mapDispatchToProps = __webpack_require__(82);
	...
	exports.default = (0, _reactRedux.connect)(_mapStateToProps2.default, _mapDispatchToProps2.default, _mergeProps2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _traverse = __webpack_require__(81);
	...
	function populateStateData(paths, state) {
	    return paths && paths.reduce(function (previous, current) {
	        try {
	            previous[current.substr(current.lastIndexOf('.') + 1)] = (0, _traverse2.default)(state, current.split('.'));
	        } catch (e) {
...
/***/ function(module, exports) {
	...
	exports.default = function (dispatch, componentProps) {
	    ...
	    if (actions != undefined) {
	        // coercive inequality is used to check against null as well
